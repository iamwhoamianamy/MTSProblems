class Program
{
    ...
    /// <remarks>Ограничение maxValue дает возможность реализовать сортировку подсчетом. Возврат с помощью yield return и фактор упорядоченности дают возможность получения 
    /// части упорядоченной последовательности без необходимости проходить по всем ее элементам. Использование словаря позволяет добиться 
    /// максимальной экономии памяти с сохранением линейной сложности алгоритма по времени. </remarks>
